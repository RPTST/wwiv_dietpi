#    
#    I have compliled WWIV on a Raspberry Pi 4 1GB using dietpi version ARMv8 (Bullseye) image
#    
#    Here is where I can see the upgrades and changes done to the source and verify it could be done.
...
#    You must run this as root. The script performs the following tasks for you:
